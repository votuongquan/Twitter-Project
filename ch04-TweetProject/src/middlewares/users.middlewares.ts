// 1. Ai do try cap vao /login
// 2. Client se gui cho minh username va password
// 3. Client se tao 1 req gui len server
// 4.thi username va password se nam o req body
...
// Viet mot middle ware xu ly validator cua reg body
...
// khi register thi ta co mot req.body gom
// name: string
// email: string
// password: string
      ...
      Authorization: {
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            // 1. verify access token nay xem co phai cua server hay ko
            try {
  ...
  checkSchema(
    {
      email_verify_token: {
        ...
        custom: {
          options: async (value: string, { req }) => {
            // neu email_verify_token khong gui len thi se res loi
            if (!value) {
              throw new ErrorWithStatus({
